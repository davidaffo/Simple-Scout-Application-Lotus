...
public class OppErrorHandler implements SkillHandler {
	
	public OppErrorHandler(){ //i use the constructor to instantly handle the main sector button
		c.game.increaseOppError();
		c.increaseOurScore();
		c.lastAction(lang.getString("oppError"), true);
		try {
			c.saveState(true);
		} catch (IOException e) {
